...
[27]Configuration
   ...
   Visit the [28]Mail System settings page at admin/settings/mailsystem to
   select which parts of Drupal will use [29]HTML Mail instead of the
   [30]default [31]mail system.

   Visit the [32]HTML Mail settings page at admin/settings/htmlmail to
...
[46]Documentation
   ...
   [49]Installing contributed modules
          [50]drupal.org/documentation/install/modules-themes/modules-5-6
...
References
  ...
  20. http://drupal.org/node/779050
  21. http://api.drupal.org/api/drupal/modules--filter--filter.module/function/_filter_autop/6
  22. http://api.drupal.org/api/drupal/modules--filter--filter.module/function/_filter_url/6
  ...
  37. http://drupal.org/node/779050
